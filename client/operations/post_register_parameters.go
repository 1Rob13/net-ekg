...
// WithUser adds the user to the post register params
func (o *PostRegisterParams) WithUser(user *models.User) *PostRegisterParams {
	o.SetUser(user)
	return o
}

// SetUser adds the user to the post register params
func (o *PostRegisterParams) SetUser(user *models.User) {
	o.User = user
}
